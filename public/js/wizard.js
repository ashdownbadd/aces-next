...
const WizardAutoSave = {
  key: "aces:member-registration:draft:v1",

  initialize() {
    // Registration data contains sensitive member PII. The server-side
    // registration/edit services already persist wizard progress in the
    // authenticated session, so do not duplicate that data in localStorage.
    this.clear();
  },
